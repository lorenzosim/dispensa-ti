...
Il Binary Symmetric Channel (BSC) è un particolare canale simmetrico composto da due simboli in ingresso e da due simboli in uscita (nè avevamo già visto un esempio in introduzione, figura \ref{fig:bsc}).
...
E' allora interessante considerare il caso intermedio, in cui M=4: si inviamo 4 parole di codice (quindi 2 bit di informazione e 1 aggiuntivo).
